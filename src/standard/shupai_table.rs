...
pub const SHUPAI_TABLE: ShupaiTable = [
    [
        ...
        [0, 0, 0, 0, 0], // n = 0
        [0, 139150, 0, 0, 0], // n = 1
        [0, 105150, 244300, 0, 0], // n = 2
        [0, 75750, 180900, 320050, 0], // n = 3
        [0, 51810, 127560, 232710, 371860], // n = 4
        [0, 33490, 85300, 161050, 266200], // n = 5
        [0, 0, 33490, 85300, 161050], // n = 6
        [0, 0, 0, 33490, 85300], // n = 7
        [0, 0, 0, 0, 33490], // n = 8
        [0, 0, 0, 0, 0], // n = 9
        [0, 0, 0, 0, 0], // n = 10
        [0, 0, 0, 0, 0], // n = 11
    ...
    [
        ...
        [0, 0, 0, 0, 0], // n = 0
        [0, 43130, 0, 0, 0], // n = 1
        [0, 34995, 78125, 0, 0], // n = 2
        [0, 27120, 62115, 105245, 0], // n = 3
        [0, 19980, 47100, 82095, 125225], // n = 4
        [0, 13925, 33905, 61025, 96020], // n = 5
        [0, 9130, 23055, 43035, 70155], // n = 6
        [0, 5595, 14725, 28650, 48630], // n = 7
        [0, 3180, 8775, 17905, 31830], // n = 8
        [0, 1660, 4840, 10435, 19565], // n = 9
        [0, 0, 1660, 4840, 10435], // n = 10
        [0, 0, 0, 1660, 4840], // n = 11
        [0, 0, 0, 0, 1660], // n = 12
        [0, 0, 0, 0, 0], // n = 13
        [0, 0, 0, 0, 0], // n = 14
    ],
    [
        ...
        [0, 3745, 8996, 15933, 24621], // n = 6
        [0, 2499, 6244, 11495, 18432], // n = 7
        [0, 1548, 4047, 7792, 13043], // n = 8
        [0, 882, 2430, 4929, 8674], // n = 9
        [0, 456, 1338, 2886, 5385], // n = 10
        [0, 210, 666, 1548, 3096], // n = 11
        [0, 84, 294, 750, 1632], // n = 12
        [0, 28, 112, 322, 778], // n = 13
        [0, 0, 28, 112, 322], // n = 14
    ],
    [
        // i = 3
        ...
        [0, 247, 679, 1366, 2373], // n = 10
        [0, 126, 373, 805, 1492], // n = 11
        [0, 56, 182, 429, 861], // n = 12
        [0, 21, 77, 203, 450], // n = 13
        [0, 6, 27, 83, 209], // n = 14
    ],
    [
        // i = 4
