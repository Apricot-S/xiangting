...
pub(in super::super) fn calculate_necessary_tiles(shoupai: &Shoupai) -> (u8, u64) {
...
pub(in super::super) fn calculate_necessary_tiles_3_player(shoupai: &Shoupai3Player) -> (u8, u64) {
    if shoupai.num_required_bingpai_mianzi < 4 {
        return (u8::MAX, 0);
    }
